...
class VisionTransformer(timm.models.vision_transformer.VisionTransformer):
    ...
    def __init__(self, image_size=(224, 224, 112), patch_size=(16,16,8), in_chans=1,
                 global_pool=False, is_fvlm=False, **kwargs):
...
def vit_large_patch16(image_size=(224, 224, 112), patch_size=(16, 16, 8), **kwargs):
    model = VisionTransformer(
        image_size=image_size, patch_size=patch_size, in_chans=1, embed_dim=1024, depth=24, num_heads=16, mlp_ratio=4, qkv_bias=True,
        norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    return model
