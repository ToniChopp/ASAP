...
def parse_opt(prefix=None):
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='../../../Data/CTRG/images_preprocessed/',
                        help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default='./chest_ctrg_r2gen_nitfy_ori_split.json',
                        help='the path to the directory containing the data.')
    parser.add_argument('--label_path', type=str, default='./data_csv/CTRG_finding_labels.csv',
    ...
    parser.add_argument('--patch_size_x', type=int, default=16, help='patch size in x direction')
    parser.add_argument('--patch_size_y', type=int, default=16, help='patch size in y direction')
    parser.add_argument('--patch_size_z', type=int, default=8, help='patch size in z direction')
    ...
    parser.add_argument('-v', '--version', type=str, default="vit", help='main model version')
    parser.add_argument("--name", type=str, default="random", help="name of the experiment")
    parser.add_argument('--visual_extractor', type=str, default='vit',
        choices=['resnet101', 'swin3d', 'vit'],
    ...
    parser.add_argument('--pretrained_path', type=str, default="random", help='path to the pretrained vit model')

    # Model settings (for Transformer)
    parser.add_argument('--d_model', type=int, default=512, help='the dimension of Transformer.')
    parser.add_argument('--d_ff', type=int, default=512, help='the dimension of FFN.')
    parser.add_argument('--d_vf', type=int, default=768, help='for densenet = 1024, for efficientnet = 1280')
    ...
    # parser.add_argument('--expe_name', type=str, default='swin3d_96_nii_scratch', help='extra experiment name')
    ...
    parser.add_argument('--warmup_steps', type=int, default=1, help='the warmup steps of the learning rate scheduler.')
    parser.add_argument('--max_epochs', type=int, default=100, help='total epochs of the learning rate scheduler.')
    ...
    # config
    parser.add_argument('--cfg', type=str, default='/data/fenghetang/report_generation/M2KT/config/ctrg_swin3d.yml',
    ...
    if args.resume == None or args.name != '':
        expe_name = f"{args.name}_" \
