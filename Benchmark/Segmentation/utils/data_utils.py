...
from monai.data import load_decathlon_datalist, list_data_collate, pad_list_data_collate
...
def get_loader(args):
    ...
    train_transform = transforms.Compose(
        [
            ...
            transforms.DeleteItemsd(keys=["image_meta_dict", "label_meta_dict", "image_transforms", "label_transforms", \
...
parser.add_argument("--task", default="MSD", type=str, help="dataset task name")
parser.add_argument("--data_dir", default="../../../../Data/MSD_Task06_Lung/", type=str, help="dataset directory")
parser.add_argument("--json_path", default="MSD_Task06_Lung_100.json", type=str, help="dataset json file")
parser.add_argument("--save_checkpoint", action="store_true", help="save checkpoint during training")
parser.add_argument("--max_epochs", default=2000, type=int, help="max number of training epochs")
parser.add_argument("--batch_size", default=50, type=int, help="number of batch size")
...
if __name__ == "__main__":
    ...
    for i, batch in enumerate(train_loader):
        try:
            print(f"Batch {i}: {[tuple(v.shape) for v in batch.values() if torch.is_tensor(v)]}")
