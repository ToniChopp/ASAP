...
# df_val, df_test = train_test_split(df_val_test, test_size=0.66667, random_state=42)
# df_val_test.to_csv("./test_list.csv", index=False)
# df_val_test.to_csv("./val_list.csv", index=False)
